...
generateprojectsFile("ProcessedData/logical_thinking_flow.csv", ["ProcessedData/abstraction_parallelism.csv","RawData/project_blocks/blockCounts.csv"], "ProcessedData/project_blocks.csv")
